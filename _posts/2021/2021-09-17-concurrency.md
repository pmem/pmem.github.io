...
split global state modifications into two steps. First, store a pointer to
newly allocated memory to a private (possibly per-thread) persistent variable
and only then make it visible for other threads.


[eadr]: https://pmem.io/glossary/#eadr
[cpp-02]: https://pmem.io/2016/01/12/cpp-02.html
