...
so it can cause an issue if you will try to recover pmemobj pool
or modify data during the check. To resolve the issue we are going to
provide COW (copy on write) mechanism accessible by CTL.
It will be available since PMDK 1.6 release.
