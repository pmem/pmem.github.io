...
:   is intended to be used with STL containers to allocate from static kinds memory. Memory management is based on the memkind library. Refer **memkind**(3) man page for more details.
