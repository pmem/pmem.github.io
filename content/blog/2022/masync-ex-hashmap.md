...
>Notifier feature is not used in hashmap example, hence it will be not discussed. For more information
...
for initializaing the `set_state` entry. Future initialization function has to conform to the
