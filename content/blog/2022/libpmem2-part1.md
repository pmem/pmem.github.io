...
for memory allocation operations on pmem. Over time,
...
[DevDax, RAS, eADR][glossary-page], and others. The initial API design was no longer sufficient
...
The previously discussed parameters were optional. But there's one important configuration
