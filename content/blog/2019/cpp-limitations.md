...
date: 2019-10-04T19:55:17-07:00
...
aliases: ['/2019/10/04/cpp-limitations.html']
...
The lifetime of an object is described in _[basic.life]_ section in the C++ standard:
...
copying it with `memcpy()` we break the _deal_ we made with that class when we used it and it
...
![diagram](/images/posts/cpptraitsdiagram.png)
