...
* Platform and CPU related [[1.1]][optimizing-computer]
    * Disable lower CPU power states: C-states [[1.2]][manage
ment-states], C1E, and memory and PCI-e power saving states. Settings vary from vendor to vendor so some of them may not be available for you e.g.:
...
* Platform and CPU related [[1.1]][optimizing-computer]
    * Disable lower CPU power states: C-states [[1.2]][manage
ment-states] and memory and PCI-e power saving states. Settings vary from vendor to vendor so some of them may not be available for you e.g.:
