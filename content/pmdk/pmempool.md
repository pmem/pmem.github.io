...
See the pmempool man page (1) for documentation and examples:
...
To see man pages for older releases see section ["Older versions" below](#older-versions).


Please note:
> If you are rather looking for a library instead of an utility, see [**libpmempool**](/pmdk/libpmempool/).
...
See the pmempool create man page:
...
See the pmempool info man page:
...
See the pmempool dump man page:
...
See the pmempool check man page:
...
For documentation of the **pmempool convert** command see man page:

- for the [current master](../manpages/linux/master/pmempool/pmempool-AAA.1.html),
- or the latest [stable version (1.12)](../manpages/linux/v1.12/pmempool/pmempool-AAA.1.html).
...
See the pmempool sync man page:
...
See the pmempool transform man page:
...
See the pmempool feature man page:
