...
The **pmemlog_ctl_get**(), **pmemlog_ctl_set**() and **pmemlog_ctl_exec**()
...
impact of pagefaults. Affects only the **pmemlog_create**() function.
...
impact of pagefaults. Affects only the **pmemlog_open**() function.
