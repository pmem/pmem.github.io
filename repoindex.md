...
<fieldset class="repo">
	...
	Their concept is based on combine market ready solutions with
	...
	described in the documentation. They use multiplication based on
	virtualization, contenerization or clustering.
	<p>
	<table>
		<tr>
			<th>Repo Name</td>
		...
		<tr>
			<td><a href="https://github.com/pmem/K8s-redis">K8s-redis</a></td>
