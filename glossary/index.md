...
This mode allows exposing PMem as a hotplugged memory region - **KMEM DAX**.
Persistent memory takes a form of a separate memory-only NUMA Node(s). In contrast to
